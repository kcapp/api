...
func main() {
	...
	router.HandleFunc("/statistics/2/{from}/{to}", controllers.GetShootoutStatistics).Methods("GET")
	router.HandleFunc("/statistics/cricket/{from}/{to}", controllers.GetCricketStatistics).Methods("GET")
	router.HandleFunc("/statistics/4/{from}/{to}", controllers.GetCricketStatistics).Methods("GET")
	router.HandleFunc("/statistics/dartsatx/{from}/{to}", controllers.GetDartsAtXStatistics).Methods("GET")
	router.HandleFunc("/statistics/5/{from}/{to}", controllers.GetDartsAtXStatistics).Methods("GET")
	router.HandleFunc("/statistics/aroundtheclock/{from}/{to}", controllers.GetAroundTheClockStatistics).Methods("GET")
	router.HandleFunc("/statistics/6/{from}/{to}", controllers.GetAroundTheWorldStatistics).Methods("GET")
	router.HandleFunc("/statistics/shanghai/{from}/{to}", controllers.GetShanghaiStatistics).Methods("GET")
	router.HandleFunc("/statistics/7/{from}/{to}", controllers.GetShanghaiStatistics).Methods("GET")
	router.HandleFunc("/statistics/aroundtheworld/{from}/{to}", controllers.GetAroundTheWorldStatistics).Methods("GET")
	router.HandleFunc("/statistics/8/{from}/{to}", controllers.GetAroundTheClockStatistics).Methods("GET")
	router.HandleFunc("/statistics/tictactoe/{from}/{to}", controllers.GetTicTacToeStatistics).Methods("GET")
	router.HandleFunc("/statistics/9/{from}/{to}", controllers.GetTicTacToeStatistics).Methods("GET")
