...
func Recalculate420Statistics(since string, dryRun bool) error {
	legs, err := GetLegsToRecalculate(models.FOURTWENTY, since)
	if err != nil {
		return err
	}
	...
	for _, leg := range legs {
		...
		for playerID, stat := range stats {
			queries = append(queries, fmt.Sprintf(`UPDATE statistics_420 SET score = %d, total_hit_rate = %f, hit_rate_1 = %f, hit_rate_2 = %f, hit_rate_3 = %f, hit_rate_4 = %f, hit_rate_5 = %f, hit_rate_6 = %f, hit_rate_7 = %f, hit_rate_8 = %f,
